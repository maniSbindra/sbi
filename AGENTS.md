...
> **SBI** (Secure Base Images) is a CLI tool that performs nightly vulnerability scanning of container base images from MCR (Microsoft Container Registry), then generates ranked recommendation reports.
